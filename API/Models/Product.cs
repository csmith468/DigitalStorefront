...
public class Product
{
    ...
    [DbColumn] public bool IsTradeable { get; set; }
    
    [DbColumn] public bool IsNew { get; set; }
    
    [DbColumn] public bool IsPromotional { get; set; }
    
    [DbColumn] public bool IsExclusive { get; set; }
