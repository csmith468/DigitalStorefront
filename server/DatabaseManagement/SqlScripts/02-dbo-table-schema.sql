IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'productType' AND schema_id = SCHEMA_ID('dbo'))
    BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'subcategory' AND schema_id = SCHEMA_ID('dbo'))
    BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'productSubcategory' AND schema_id = SCHEMA_ID('dbo'))
    BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'productImage' AND schema_id = SCHEMA_ID('dbo'))
    BEGIN
